            ...
            <div class="card-body">
                <form action="{{ route('observation.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <select name="patient_id" id="patient_id"
                                ...
                                @foreach ($patients as $patient)
                                    <option value="{{ $patient->id }}"
                                        ...
                                        {{ $patient->nama }} ({{ $patient->mr_number }})
                                    </option>
                                @endforeach
                            </select>
                            @error('patient_id')
                            ...
                            <div class="row gy-3">
                                <div class="col-md-3">
                                    ...
                                    <input type="number" step="0.1" id="suhu" name="suhu"
                                        class="form-control @error('suhu') is-invalid @enderror" placeholder="36.7"
                                        value="{{ old('suhu') }}">
                                    @error('suhu')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" id="tekanan_darah" name="tekanan_darah"
                                        ...
                                        placeholder="120/80" value="{{ old('tekanan_darah') }}">
                                    @error('tekanan_darah')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="number" id="nadi" name="nadi"
                                        class="form-control @error('nadi') is-invalid @enderror" placeholder="80"
                                        value="{{ old('nadi') }}">
                                    @error('nadi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="number" id="pernapasan" name="pernapasan"
                                        class="form-control @error('pernapasan') is-invalid @enderror" placeholder="18"
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="number" id="saturasi" name="saturasi"
                                        class="form-control @error('saturasi') is-invalid @enderror" placeholder="98"
                                        min="0" max="100" value="{{ old('saturasi') }}">
                                    @error('saturasi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="card-body">
                            <div class="row gy-3">
                                <div class="col-md-4">
                                    ...
                                    <select name="respiratory_support_type" id="respiratory_support_type"
                                        class="form-select @error('respiratory_support_type') is-invalid @enderror">
                                        <option value="">– Pilih –</option>
                                        <option value="none"
                                            {{ old('respiratory_support_type') == 'none' ? 'selected' : '' }}>None</option>
                                        <option value="nasal_cannula"
                                            {{ old('respiratory_support_type') == 'nasal_cannula' ? 'selected' : '' }}>
                                            Nasal
                                            Cannula</option>
                                        <option value="masker_sederhana"
                                            {{ old('respiratory_support_type') == 'masker_sederhana' ? 'selected' : '' }}>
                                            Masker
                                            Sederhana</option>
                                        <option value="high_flow"
                                            {{ old('respiratory_support_type') == 'high_flow' ? 'selected' : '' }}>High
                                            Flow
                                        </option>
                                        <option value="ventilator"
                                            {{ old('respiratory_support_type') == 'ventilator' ? 'selected' : '' }}>
                                            Ventilator
                                        </option>
                                    </select>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="number" id="oxygen_flow_rate" name="oxygen_flow_rate"
                                        class="form-control @error('oxygen_flow_rate') is-invalid @enderror"
                                        placeholder="2" value="{{ old('oxygen_flow_rate') }}">
                        ...
                        <div class="card-body">
                            <div class="row gy-3">
                                <div class="col-md-2">
                                    ...
                                    <input type="number" id="pain_scale" name="pain_scale"
                                        class="form-control @error('pain_scale') is-invalid @enderror" min="0"
                                        max="10" value="{{ old('pain_scale') }}">
                                    @error('pain_scale')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="pain_location" name="pain_location"
                                        ...
                                        placeholder="Perut kanan atas" value="{{ old('pain_location') }}">
                                    @error('pain_location')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="pain_character" name="pain_character"
                                        class="form-control @error('pain_character') is-invalid @enderror"
                                        placeholder="Tajam" value="{{ old('pain_character') }}">
                            ...
                            <div class="row gy-3">
                                <div class="col-md-2">
                                    ...
                                    <select id="gcs_eye" name="gcs_eye"
                                        ...
                                        @for ($i = 1; $i <= 4; $i++)
                                            <option value="{{ $i }}"
                                                {{ old('gcs_eye') == $i ? 'selected' : '' }}>{{ $i }}</option>
                                        @endfor
                                    </select>
                                    @error('gcs_eye')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="number" id="total_gcs" name="total_gcs" class="form-control" readonly
                                        value="{{ old('total_gcs', '') }}">
                                    {{-- readonly agar dihitung otomatis --}}
                                </div>
                            </div>
                            <small class="text-muted">Total GCS dihitung otomatis ketika Anda memilih
                                Eye/Verbal/Motor.</small>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row gy-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="number" step="0.01" id="glukosa_sewaktu" name="glukosa_sewaktu"
                                        class="form-control @error('glukosa_sewaktu') is-invalid @enderror"
                                        placeholder="5.65" value="{{ old('glukosa_sewaktu') }}">
                        ...
                        <div class="card-body">
                            <div class="row gy-3">
                                <div class="col-md-3">
                                    ...
                                    <input type="number" id="fluid_intake_cc" name="fluid_intake_cc"
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="number" id="fluid_output_cc" name="fluid_output_cc"
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="number" id="balance_fluid_cc" name="balance_fluid_cc"
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            <textarea id="intervention_given" name="intervention_given"
                                class="form-control @error('intervention_given') is-invalid @enderror" rows="2"
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            <input type="datetime-local" id="next_observed_at" name="next_observed_at"
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            <textarea id="current_allergy_reaction" name="current_allergy_reaction"
                                class="form-control @error('current_allergy_reaction') is-invalid @enderror" rows="2"
                        ...
                        <div class="card-body">
                            <select name="mobility_status" id="mobility_status"
                                ...
                                <option value="independent"
                                    {{ old('mobility_status') == 'independent' ? 'selected' : '' }}>
                                    Independent</option>
                                <option value="assist" {{ old('mobility_status') == 'assist' ? 'selected' : '' }}>Assist
                                </option>
                                <option value="bedridden" {{ old('mobility_status') == 'bedridden' ? 'selected' : '' }}>
                                    Bedridden</option>
                            </select>
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            <textarea id="mental_status_notes" name="mental_status_notes"
                                class="form-control @error('mental_status_notes') is-invalid @enderror" rows="2"
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            <input type="file" id="attachment_photo" name="attachment_photo"
                                class="form-control @error('attachment_photo') is-invalid @enderror" accept="image/*">
                            ...
                            {{-- Preview kecil --}}
                            <div class="mt-2">
                                <img id="preview-photo" src="#" alt="Preview Gambar" class="img-fluid"
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            <textarea id="catatan" name="catatan" class="form-control @error('catatan') is-invalid @enderror" rows="3"

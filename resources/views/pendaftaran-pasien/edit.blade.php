{{-- resources/views/pendaftaran-pasien/edit.blade.php --}}
...
<div class="container-fluid py-4">
    ...
    <form action="{{ route('patiens.update', EncryptHelper::encryptId($data->id)) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input
                        ...
                        id="mr_number"
                        name="mr_number"
                        class="form-control bg-light @error('mr_number') is-invalid @enderror"
                        value="{{ old('mr_number', $data->mr_number) }}"
                        readonly
                    >
                    @error('mr_number')
                ...
                <div class="row gx-3 gy-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <select
                                ...
                                required
                            >
                                <option value="" disabled {{ old('gender', $data->gender) ? '' : 'selected' }}>
                                    Pilih Jenis Kelamin
                                </option>
                                <option value="L" {{ old('gender', $data->gender) == 'L' ? 'selected' : '' }}>
                                    Laki‐Laki
                                </option>
                                <option value="P" {{ old('gender', $data->gender) == 'P' ? 'selected' : '' }}>
                                    Perempuan
                                </option>
                            </select>
                            @error('gender')
                        ...
                        <div class="mb-3">
                            ...
                            >
                                <option value="" disabled {{ old('agama', $data->agama) ? '' : 'selected' }}>
                                    Pilih Agama
                                </option>
                        ...
                        {{-- Penyedia Asuransi --}}
                        <div class="mb-3">
                            <label for="penyedia_asuransi" class="form-label">Penyedia Asuransi</label>
                            <input
                                type="text"
                                id="penyedia_asuransi"
                                name="penyedia_asuransi"
                                class="form-control @error('penyedia_asuransi') is-invalid @enderror"
                                value="{{ old('penyedia_asuransi', $data->penyedia_asuransi) }}"
                                placeholder="Masukkan penyedia asuransi"
                            >
                            @error('penyedia_asuransi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input
                                ...
                                value="{{ old('nomor_asuransi', $data->nomor_asuransi) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            >
                                <option value="" disabled {{ old('type_darah', $data->type_darah) ? '' : 'selected' }}>
                                    Pilih Gol. Darah
                                </option>
                                <option value="A"  {{ old('type_darah', $data->type_darah) == 'A' ? 'selected' : '' }}>A</option>
                                <option value="B"  {{ old('type_darah', $data->type_darah) == 'B' ? 'selected' : '' }}>B</option>
                                <option value="AB" {{ old('type_darah', $data->type_darah) == 'AB' ? 'selected' : '' }}>AB</option>
                                <option value="O"  {{ old('type_darah', $data->type_darah) == 'O' ? 'selected' : '' }}>O</option>
                            </select>
                            @error('type_darah')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input
                                ...
                                value="{{ old('telepon_kontak_darurat', $data->telepon_kontak_darurat) }}"
                                placeholder="Masukkan nomor telepon"
                            >
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input
                                ...
                                value="{{ old('hubungan_kontak_darurat', $data->hubungan_kontak_darurat) }}"

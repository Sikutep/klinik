...
<body class="d-flex">
    ...
    <nav class="sidebar bg-light d-flex flex-column p-3 vh-100">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            <a
                href="#"
                class="nav-link mb-2 {{ request()->is('dashboard') ? 'active' : '' }}"
            ...
            <li>
                <a
                    href="{{ url('/pendaftaran-pasien') }}"
                    class="nav-link mb-2 {{ request()->is('pendaftaran-pasien') ? 'active' : '' }}"
                    style="font-size: 16px; font-weight: bold">
            ...
            <li>
                <a
                    href="{{ url('/antrian') }}"
                    class="nav-link mb-2 {{ request()->is('antrian') ? 'active' : '' }}"
                    style="font-size: 16px; font-weight: bold">
            ...
            <li>
                <a
                    href="#"
                    class="nav-link mb-2 {{ request()->is('kasir') ? 'active' : '' }}"
                    style="font-size: 16px; font-weight: bold">
            ...
            <li>
                <a
                    href="#"
                    class="nav-link mb-2 {{ request()->is('observasi') ? 'active' : '' }}"
                    style="font-size: 16px; font-weight: bold">
            ...
            <li>
                <a
                    href="#"
                    class="nav-link mb-2 {{ request()->is('laporan ') ? 'active' : '' }}"
                    style="font-size: 16px; font-weight: bold">
    ...
    <div class="content-wrapper d-flex flex-column">
        <!-- Header Topbar -->
        <header
            class="d-flex justify-content-end align-items-center p-3 border-bottom"
